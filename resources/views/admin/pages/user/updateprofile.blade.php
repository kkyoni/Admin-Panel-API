                ...
                <div class="ibox ">
                   <!--  <div class="form-group row {{ $errors->has('username') ? 'has-error' : '' }}">
                    ...
                    <div class="form-group row {{ $errors->has('fname') ? 'has-error' : '' }}">
                        ...
                        <div class="col-lg-12">
                            <input type="text" placeholder="First Name"  value="{{$user->fname}}" id="fname" name="fname" class="form-control" maxlength="30" required>
                            <span class="help-block">
                                <font color="red"> {{ $errors->has('fname') ? "".$errors->first('fname')."" : '' }} </font>
                            </span>
                        </div>
                    </div>
